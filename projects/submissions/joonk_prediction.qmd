...
research_question <- "administrative burden이 디지털 서비스 이용의사에 주는 영향과 adminitrative burden 유형별 상대적 임팩트 크기 분석"

expected_contribution <- "이 연구가 추가할 수 있는 학술적 또는 정책적 기여를 1~3문장으로 적으세요.
"
```
...
prediction_use <- "디지털 서비스와 관련도가높은 administrative burden 중심으로 사용자 비용을 최소화할 수있는 정책 마련의 근거로 제시"
